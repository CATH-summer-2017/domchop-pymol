...
def print_err(): #prints the error nicely
	print("Content-type: text/plain\n")
	print("The script encountered the following problem:\n")
	print(traceback.format_exc())
	sys.exit()
bindir = os.path.abspath(os.path.dirname(sys.argv[0]))#get dir of process
...
try:
	pdb_file = open(pdb_dir + pdb_id_chain[0:4] + is_pdb, 'r')
except:
	print(err)
